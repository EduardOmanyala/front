...
urlpatterns = [
    ...
    path('orders/mods/dashboard', front_views.OrderListViewMods, name='order-list-view-mods'),
    ...
    path('order/details/messages/<int:id>/', front_views.OrderMessagesNotification, name='client-messages'),
    path('order/details/notifications/messages/<int:id>/', front_views.OrderMessagesNotificationMod, name='mod-messages-email'),
    path('order/details/notifications/complete/<int:id>/', front_views.OrderCompleteNotification, name='order-complete-email'),
